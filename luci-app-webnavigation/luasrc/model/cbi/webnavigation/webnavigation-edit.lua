...
m = Map(webnavigation, translate("Config 网址导航"))
m.pageaction = false
...
---- name
o = s:option(Value, "webname", translate("webname"))
o.description = font_red..bold_on..translate("Name For Distinguishing")..bold_off..font_off
o.placeholder = translate("config")
o.rmempty = true

---- address
o = s:option(Value, "weburl", translate("weburl"))
o.description = font_red..bold_on..translate("WEB地址")..bold_off..font_off
o.placeholder = translate("http")
o.rmempty = true
...
o.inputstyle = "reset"
o.write = function()
   m.uci:revert(webnavigation, sid)
   luci.http.redirect(m.redirect)
end
